...
Each vehicle is a separate thread. Horizontal vehicles threads are ending, after they leave the track. New threads are dynamically created by another, managing thread. <br />
There are four crossroads where tracks intersect. Vehicles, when entering these crossroads, ensure there are no oncoming vehicles from other directions to avoid collisions.
